    ...
    <div class="box">
        ...
        <div class="col-md-12 table">
            <table>
                ...
                @if (count($assignmentsWithoutSubmission) > 0)
                    @foreach ($assignmentsWithoutSubmission as $row)
                ...
                @if (count($assignmentsWithSubmission) > 0)
                    @foreach ($assignmentsWithSubmission as $row)
                        <tr @if($row?->date_of_submission) style="background-color: lightgreen" @endif>
                            <td>{{ $row?->assignment_title }}</td>
                            <td>{{ $row?->assignment_description }}</td>
                            <td>{{ $row?->completion_date }}</td>
